...
static void deviceType_helper(cl_device_type deviceType)
{
...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			double globalMemMB = static_cast<double>(globalMemSize) / 1'000'000.0;
			std::cout << "\t\t\tGlobal mem size: " << globalMemMB << " MB" << std::endl;
			...
			cl_uint clockFreqMHz = 0;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_MAX_CLOCK_FREQUENCY, sizeof(clockFreqMHz), &clockFreqMHz, nullptr));
			std::cout << "\t\t\tClock frequency: " << clockFreqMHz << " MHz" << std::endl;

...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		// Падает ошибка -30, которая не на 103 строке, а на 204...
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			size_t maxImage2DWidth = 0;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_IMAGE2D_MAX_WIDTH, sizeof(maxImage2DWidth), &maxImage2DWidth, nullptr));
			std::cout << "        Max 2D texture width: " << maxImage2DWidth << std::endl;

...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		cl_int err = clGetPlatformInfo(platform, 239, 0, nullptr, nullptr);
		std::cout << "Error code for clGetPlatformInfo(platform, 239, 0, nullptr, nullptr): " << err
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			if(deviceType & CL_DEVICE_TYPE_CPU)
				std::cout << " CPU";
			if(!(deviceType & CL_DEVICE_TYPE_CPU) && !(deviceType & CL_DEVICE_TYPE_GPU))
				std::cout << " other";
			std::cout << std::endl;

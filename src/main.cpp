...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		// Некорректный param_name (например, 239) дает CL_INVALID_VALUE (-30).
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			std::cout << "\tGlobal memory: " << globalMemorySize / (1024 * 1024) << " MiB" << std::endl;
			...
			std::cout << "\tLocal memory: " << localMemorySize / 1024 << " KiB" << std::endl;
		}
	}

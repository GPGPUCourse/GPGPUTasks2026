...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		std::cout << "    OpenCL devices count: " << devicesCount << std::endl;
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_MAX_COMPUTE_UNITS, sizeof(computeUnitsCount), &computeUnitsCount, nullptr));
			std::cout << "        Max compute units: " << computeUnitsCount << std::endl;

...
void run(int argc, char** argv)
{
...

    {
        ...
        for (int iter = 0; iter < 10; ++iter) {
            ...
            // Одна нить на строку, рабочая группа из GROUP_SIZE=256 нитей
            gpu::WorkSize workSize(GROUP_SIZE, height);
        ...
        // Два чтения и одна запись на каждый элемент матрицы
...

    {
        ...
        for (int iter = 0; iter < 10; ++iter) {
            ...
            // Одна нить на столбец, рабочая группа из GROUP_SIZE=256 нитей

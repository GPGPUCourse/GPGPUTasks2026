...
void run(int argc, char** argv)
{
...

    {
        ...
        for (int iter = 0; iter < 10; ++iter) {
            ...
            // попробовал 256 x 1, затем 16 x 16. Увидел, что во втором случае скорость передачи по шине
            // выше на ~75 GB/s по времени значения те же самые.
            // Попробовал 128 x 2 - значения такие же как у 16x16 поэтому оставил так
            gpu::WorkSize workSize(128, 2, width, height);

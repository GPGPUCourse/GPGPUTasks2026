...
void run(int argc, char** argv)
{
...

    {
        ...
        const double memory_size_gb = 3.0 * sizeof(unsigned int) * width * height / (1024.0 * 1024.0 * 1024.0);
        const double median_time = stats::median(times);

        std::cout << "BAD median effective memory bandwidth: " << memory_size_gb / median_time << " GB/s" << std::endl;
        ...
        std::cout << "BAD result is correct" << std::endl;
    }
...

    {
        ...
        std::cout << "GOOD median effective memory bandwidth: " << memory_size_gb / median_time << " GB/s" << std::endl;
        ...
        std::cout << "GOOD result is correct" << std::endl;
    }
}
